...
export type JobInput={title:string;description:string;category_id:string;municipality_code:string;city:string;province_code:string;province:string;contract_type:string;experience_required:string;availability_required:string;salary_range?:string|null};
